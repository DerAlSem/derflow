...
#
# 🔴 ЗАМЕРЫ ПРИЁМКИ (11.09.2026, 102 укуса, после круга починки финального ревью).
...
#
#   живой waiting.py .......................... ✅ 102 ❌ 0
#   заглушка (print + exit 0) ................. ✅ 0   ❌ 102
#   claim_name дописывает pid к имени ......... ✅ 100 ❌ 2
#   repo_box берёт --show-toplevel мимо
#     worktree_main ........................... ✅ 100 ❌ 2
#   boxes() не добавляет HOME/BOX строкой ..... ✅ 58  ❌ 44
#   classify при отсутствии кэша — «молчит» ... ✅ 90  ❌ 12
#   id беспроектной строки не `home` (Р4) ..... ✅ 99  ❌ 3
#   пометка «снята» не вставляется в вывод .... ✅ 100 ❌ 2
#
...
{ [ "$rc" = 0 ] && inf "$HB/20260808-02.md" "state: done            # waiting | done"; }
