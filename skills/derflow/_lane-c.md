...
- **Адаптированные сшивки гейтятся `_conformance-sweep`** (файл: `~/.claude/skills/_conformance-sweep.md` — это не скилл, его читают, а не вызывают). Изменение, трогающее адаптированную сшивку, гоняет мини-свип затронутых `normative` SHALL'ов *до* archive — ловит «твоё изменение противоречит SHALL» (обнови спеку сознательно, либо изменение неверное).
