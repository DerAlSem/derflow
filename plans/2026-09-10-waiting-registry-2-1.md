...
> **✅ ПОСТАВЛЕНО 11.09.2026.** Пять задач закрыты, стенд 90 укусов: живой
> ✅ 90 ❌ 0, заглушка ✅ 0 ❌ 90, четыре нарочные поломки сторожа краснеют
> (числа — в шапке `scripts/waiting-bite.sh`). Ход исполнения и двенадцать
> решений по ходу — `.superpowers/sdd/2026-09-10-waiting-registry-2-1/progress.md`.
> Строка `home/20260908-01` остаётся недооформленной намеренно (Р12): её
> дооформляет миграция 2-3.
